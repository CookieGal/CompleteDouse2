...
draw_sprite(spr_timer_john, john.image_index, (x - 150) + barpos, y + 150)
draw_sprite(pizzaface.sprite_index, pizzaface.image_index, x + 150, y + 150)
